...
@router.post(
    "/tipos",
    response_model=TipoAportacionRespuesta,
    summary="Crear tipo de aportacion",
    dependencies=[Depends(requerir_roles(RolUsuario.ADMINISTRADOR))],
)
...
@router.get(
    "/tipos",
    response_model=list[TipoAportacionRespuesta],
    summary="Listar tipos de aportacion",
    dependencies=[
        Depends(
            requerir_roles(
...
@router.post(
    "/deposito",
    response_model=AportacionRespuesta,
    summary="Registrar deposito de aportacion",
...
@router.post(
    "/retiro",
    response_model=AportacionRespuesta,
    summary="Registrar retiro de aportacion",
    dependencies=[Depends(requerir_roles(RolUsuario.ADMINISTRADOR, RolUsuario.CAJERO))],
)
...
@router.get(
    "",
    response_model=list[AportacionRespuesta],
...
@router.get(
    "/socio/{socio_id}",
    response_model=list[AportacionRespuesta],
    summary="Aportaciones por socio",
    dependencies=[
        Depends(
            requerir_roles(
                RolUsuario.ADMINISTRADOR,
